...
class CommandLineParserImplTest {
    ...
    public static Stream<Arguments> commandLines() {
        return Stream.of(
                ...
                Arguments.of("Команда \"--par1:Это одна \\\" строка\" --par2:67 43 --par4:ВтораяСтрока \"--par5:\\\"ТретьяСтрока\\\"\"",
                        List.of("Команда", "--par1:Это одна \" строка", "--par2:67", "43", "--par4:ВтораяСтрока", "--par5:\"ТретьяСтрока\""))
        );
    }
